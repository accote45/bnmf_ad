#!/bin/bash
#BSUB -J harmonize_mpv_rerun_a
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_mpv_rerun_a_%J.out
#BSUB -e logs/lsf/harmonize_mpv_rerun_a_%J.err

# Rerun: missing Mean Platelet Volume files (batch A — 3 files)
...
echo ""
echo "=== MeanPltVol rerun A complete ==="
