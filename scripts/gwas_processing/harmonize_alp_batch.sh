#!/bin/bash
#BSUB -J harmonize_alp
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_alp_%J.out
#BSUB -e logs/lsf/harmonize_alp_%J.err

# Harmonize ALP GWAS files (3 total):
#   Karczewski_NatGenet_2025 — META, SAS
...
FILES=(
    "Karczewski_NatureGenetics_2025.ALP.META.GRCh37.txt.gz|META"
    "Karczewski_NatureGenetics_2025.ALP.SAS.GRCh37.txt.gz|SAS"
    "Gurdasani_Cell_2019.ALP.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== ALP harmonization complete ==="
