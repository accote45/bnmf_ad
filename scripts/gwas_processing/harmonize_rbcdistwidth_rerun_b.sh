#!/bin/bash
#BSUB -J harmonize_rdw_rerun_b
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_rdw_rerun_b_%J.out
#BSUB -e logs/lsf/harmonize_rdw_rerun_b_%J.err

# Rerun: missing RBC Distribution Width files (batch B — 2 files)
...
echo ""
echo "=== RBCDistWidth rerun B complete ==="
