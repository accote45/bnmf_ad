#!/bin/bash
#BSUB -J harmonize_atherosclerosis
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 12:00
#BSUB -o logs/lsf/harmonize_atherosclerosis_%J.out
#BSUB -e logs/lsf/harmonize_atherosclerosis_%J.err

# Harmonize 8 atherosclerosis GWAS files: Karczewski (3), Verma (5).
# All files are GRCh37 — no liftover needed.
# No reference GWAS available (first atherosclerosis batch).
...
# No reference GWAS — first atherosclerosis batch

# Files to harmonize: raw_filename|ancestry
FILES=(
    # Karczewski 2025 (BETA, GWAS Catalog format, no N column)
    "Karczewski_NatGenet_2025.atherosclerosis.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.atherosclerosis.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.atherosclerosis.SAS.GRCh37.txt.gz|SAS"
    # Verma 2024 (OR only, GWAS Catalog format, has n)
    "Verma_Science_2024.atherosclerosis.META.GRCh37.tsv.gz|META"
    "Verma_Science_2024.atherosclerosis.EUR.GRCh37.tsv.gz|EUR"
    "Verma_Science_2024.atherosclerosis.AFR.GRCh37.tsv.gz|AFR"
    "Verma_Science_2024.atherosclerosis.EAS.GRCh37.tsv.gz|EAS"
    "Verma_Science_2024.atherosclerosis.AMR.GRCh37.tsv.gz|AMR"
)
...
"
    ...
    # Build harmonize command (no reference GWAS for atherosclerosis)
    ...
    echo "  Harmonizing (no reference GWAS available)..."
...
echo ""
echo "=== Atherosclerosis batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized atherosclerosis files: $(ls ${HARMONIZED}/*atherosclerosis*.processed.txt.gz 2>/dev/null | wc -l)"
