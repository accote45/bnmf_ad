#!/bin/bash
#BSUB -J harmonize_phos
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_phos_%J.out
#BSUB -e logs/lsf/harmonize_phos_%J.err

# Harmonize Phosphate GWAS files (3 total):
...
FILES=(
    "Karczewski_NatGenet_2025.Phosphate.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.Phosphate.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.Phosphate.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== Phosphate batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*Phosphate*.processed.txt.gz 2>/dev/null | wc -l)"
