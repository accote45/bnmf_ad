#!/bin/bash
#BSUB -J harmonize_prot
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_prot_%J.out
#BSUB -e logs/lsf/harmonize_prot_%J.err

# Harmonize Protein GWAS files (4 total):
...
FILES=(
    ...
    "Karczewski_NatGenet_2025.Protein.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.Protein.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.Protein.SAS.GRCh37.txt.gz|SAS"
    # Sakaue NatGenet 2021
    "Sakaue_NatGenet_2021.Protein.EAS.GRCh37.txt.gz|EAS"
)
...
echo ""
echo "=== Protein batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*Protein*.processed.txt.gz 2>/dev/null | wc -l)"
