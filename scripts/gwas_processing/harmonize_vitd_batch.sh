#!/bin/bash
#BSUB -J harmonize_vitd
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_vitd_%J.out
#BSUB -e logs/lsf/harmonize_vitd_%J.err

# Harmonize Vitamin D GWAS files (5 total):
#   Karczewski_NatGenet_2025 — META, EUR, SAS, AFR
...
FILES=(
    "Karczewski_NatGenet_2025.VitD.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.VitD.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.VitD.SAS.GRCh37.txt.gz|SAS"
    "Karczewski_NatGenet_2025.VitD.AFR.GRCh37.txt.gz|AFR"
    "Jacobs_NatureComms_2024.VitD.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== Vitamin D harmonization complete ==="
