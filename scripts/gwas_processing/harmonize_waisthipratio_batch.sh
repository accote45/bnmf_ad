#!/bin/bash
#BSUB -J harmonize_whr
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_whr_%J.out
#BSUB -e logs/lsf/harmonize_whr_%J.err

# Harmonize Waist-Hip Ratio GWAS files (7 total):
#   Justice_NatGenet_2019 — META
#   Karczewski_NatGenet_2025 — META, EUR, AFR
#   Chen_CellGenomics_2023 — EAS
#   FernandezRhodes_HGGAdv_2022 — AMR
...
FILES=(
    "Justice_NatGenet_2019.WaistHipRatio.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.WaistHipRatio.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.WaistHipRatio.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.WaistHipRatio.AFR.GRCh37.txt.gz|AFR"
    "Chen_CellGenomics_2023.WaistHipRatio.EAS.GRCh37.tsv.gz|EAS"
    "FernandezRhodes_HGGAdv_2022.WaistHipRatio.AMR.GRCh37.txt.gz|AMR"
    "Gurdasani_Cell_2019.WaistHipRatio.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== Waist-Hip Ratio harmonization complete ==="
