#!/bin/bash
#BSUB -J harmonize_bili_a
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=128000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_bili_a_%J.out
#BSUB -e logs/lsf/harmonize_bili_a_%J.err

# Harmonize Bilirubin GWAS files (batch A — UKB files, 128GB mem):
...
echo ""
echo "=== Bilirubin batch A harmonization complete ==="
