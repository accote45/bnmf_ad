#!/bin/bash
#BSUB -J harmonize_crp
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_crp_%J.out
#BSUB -e logs/lsf/harmonize_crp_%J.err

# Harmonize CRP GWAS files (5 total):
#   Karczewski_NatGenet_2025 — EUR, SAS
#   Verma_Science_2024 — META, EUR, AFR
...
FILES=(
    "Karczewski_NatGenet_2025.CRP.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.CRP.SAS.GRCh37.txt.gz|SAS"
    "Verma_Science_2024.CRP.META.GRCh37.txt.gz|META"
    "Verma_Science_2024.CRP.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.CRP.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== CRP harmonization complete ==="
