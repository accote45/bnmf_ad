#!/bin/bash
#BSUB -J harmonize_apo
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_apo_%J.out
#BSUB -e logs/lsf/harmonize_apo_%J.err

# Harmonize ApoA + ApoB GWAS files (3 total):
#   Karjalainen_Nature_2024 — ApoA META, ApoB META
#   Karczewski_NatGenet_2025 — ApoB SAS
...
FILES=(
    "Karjalainen_Nature_2024.ApoA.META.GRCh37.tsv.gz|META"
    "Karczewski_NatureGenetics_2025.ApoB.SAS.GRCh37.txt.gz|SAS"
    "Karjalainen_Nature_2024.ApoB.META.GRCh37.tsv.gz|META"
)
...
echo ""
echo "=== ApoA/ApoB harmonization complete ==="
