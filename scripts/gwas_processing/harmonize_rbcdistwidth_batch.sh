#!/bin/bash
#BSUB -J harmonize_rdw
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_rdw_%J.out
#BSUB -e logs/lsf/harmonize_rdw_%J.err

# Harmonize all RBC Distribution Width (RBCDistWidth) GWAS files (13 total):
#   Karczewski_NatGenet_2025 — EUR, META, SAS
#   Verma_Science_2024       — EUR, AFR, EAS, AMR, META
#   Chen_Cell_2020           — EUR, AFR, SAS, AMR
...
FILES=(
    ...
    "Karczewski_NatGenet_2025.RBCDistWidth.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.RBCDistWidth.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.RBCDistWidth.SAS.GRCh37.txt.gz|SAS"
    # Verma Science 2024
    "Verma_Science_2024.RBCDistWidth.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.RBCDistWidth.AFR.GRCh37.txt.gz|AFR"
    "Verma_Science_2024.RBCDistWidth.EAS.GRCh37.txt.gz|EAS"
    "Verma_Science_2024.RBCDistWidth.AMR.GRCh37.txt.gz|AMR"
    "Verma_Science_2024.RBCDistWidth.META.GRCh37.txt.gz|META"
    # Chen Cell 2020
    "Chen_Cell_2020.RBCDistWidth.EUR.GRCh37.txt.gz|EUR"
    "Chen_Cell_2020.RBCDistWidth.AFR.GRCh37.txt.gz|AFR"
    "Chen_Cell_2020.RBCDistWidth.SAS.GRCh37.txt.gz|SAS"
    "Chen_Cell_2020.RBCDistWidth.AMR.GRCh37.txt.gz|AMR"
    # Gurdasani Cell 2019 (custom METAL format)
    "Gurdasani_Cell_2019.RBCDistWidth.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== RBCDistWidth batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*RBCDistWidth*.processed.txt.gz 2>/dev/null | wc -l)"
