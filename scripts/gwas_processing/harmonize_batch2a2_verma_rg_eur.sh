#!/bin/bash
#BSUB -J harm_verma_rg_eur
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=32000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harm_verma_rg_eur_%J.out
#BSUB -e logs/lsf/harm_verma_rg_eur_%J.err

# Verma RandomGlucose EUR (583 MB)
...
echo ""
echo "=== Verma RandomGlucose EUR harmonization complete ==="
