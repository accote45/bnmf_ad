#!/bin/bash
#BSUB -J harmonize_bilirubin
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_bilirubin_%J.out
#BSUB -e logs/lsf/harmonize_bilirubin_%J.err

# Harmonize Bilirubin GWAS files (4 total):
...
FILES=(
    "UKB_Nature_2025.Bilirubin.EUR.GRCh37.tsv.gz|EUR"
    "UKB_Nature_2025.Bilirubin.AFR.GRCh37.tsv.gz|AFR"
    "UKB_Nature_2025.Bilirubin.SAS.GRCh37.tsv.gz|SAS"
    "Chen_CellGenomics_2023.Bilirubin.EAS.GRCh37.tsv.gz|EAS"
)
...
echo ""
echo "=== Bilirubin harmonization complete ==="
