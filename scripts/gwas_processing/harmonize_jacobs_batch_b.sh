#!/bin/bash
#BSUB -J harmonize_jacobs_b
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_jacobs_b_%J.out
#BSUB -e logs/lsf/harmonize_jacobs_b_%J.err

# Harmonize Jacobs NatureComms 2024 SAS GWAS (batch B — 7 files):
#   Eosinophilcount, GGT, FastingGlucose, RandomGlucose, LymphocyteCount, MCV, MonocyteCount
...
FILES=(
    "Jacobs_NatureComms_2024.Eosinophilcount.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.GGT.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.FastingGlucose.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.RandomGlucose.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.LymphocyteCount.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.MCV.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.MonocyteCount.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== Jacobs batch B harmonization complete ==="
