#!/bin/bash
#BSUB -J harmonize_mono
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_mono_%J.out
#BSUB -e logs/lsf/harmonize_mono_%J.err

# Harmonize MonocyteCount GWAS files (10 total):
#   Chen_Cell_2020 — EUR, EAS, AMR
#   Karczewski_NatGenet_2025 — META, EUR, SAS
#   Verma_Science_2024 — META, EUR, AFR, AMR
...
FILES=(
    "Chen_Cell_2020.MonocyteCount.EUR.GRCh37.txt.gz|EUR"
    "Chen_Cell_2020.MonocyteCount.EAS.GRCh37.txt.gz|EAS"
    "Chen_Cell_2020.MonocyteCount.AMR.GRCh37.txt.gz|AMR"
    "Karczewski_NatGenet_2025.MonocyteCount.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.MonocyteCount.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.MonocyteCount.SAS.GRCh37.txt.gz|SAS"
    "Verma_Science_2024.MonocyteCount.META.GRCh37.txt.gz|META"
    "Verma_Science_2024.MonocyteCount.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.MonocyteCount.AFR.GRCh37.txt.gz|AFR"
    "Verma_Science_2024.MonocyteCount.AMR.GRCh37.txt.gz|AMR"
)
...
echo ""
echo "=== MonocyteCount harmonization complete ==="
