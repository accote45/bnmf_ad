#!/bin/bash
#BSUB -J harmonize_urate
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 12:00
#BSUB -o logs/lsf/harmonize_urate_%J.out
#BSUB -e logs/lsf/harmonize_urate_%J.err

# Harmonize Urate GWAS files (5 total):
#   Cho_NatureComms_2024 — META, EAS
...
FILES=(
    # Cho NatureComms 2024
    "Cho_NatureComms_2024.Urate.META.GRCh37.tsv.gz|META"
    "Cho_NatureComms_2024.Urate.EAS.GRCh37.tsv.gz|EAS"
    # UKB Nature 2025
    "UKB_Nature_2025.Urate.EUR.GRCh37.tsv.gz|EUR"
    "UKB_Nature_2025.Urate.AFR.GRCh37.tsv.gz|AFR"
    "UKB_Nature_2025.Urate.SAS.GRCh37.tsv.gz|SAS"
)
...
echo ""
echo "=== Urate batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*Urate*.processed.txt.gz 2>/dev/null | wc -l)"
