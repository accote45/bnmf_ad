#!/bin/bash
#BSUB -J harm_batch2_eur_meta
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harm_batch2_eur_meta_%J.out
#BSUB -e logs/lsf/harm_batch2_eur_meta_%J.err

# Batch 2: EUR + META harmonization (9 files, ~9.8 GB)
...
FILES=(
    "Verma_Science_2024.Creatinine.EUR.GRCh37.txt.gz|EUR"
    "Chen_Cell_2020.Eosinophilcount.EUR.GRCh37.txt.gz|EUR"
    "Vuckovic_Cell_2020.Hgb.EUR.GRCh37.txt.gz|EUR"
    "UKB_Nature_2025.RandomGlucose.EUR.GRCh37.tsv.gz|EUR"
    "Verma_Science_2024.RandomGlucose.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.Creatinine.META.GRCh37.txt.gz|META"
    "Chen_NatureGenetics_2021.Hba1c.META.GRCh37.txt.gz|META"
    "Verma_Science_2024.RBCDistWidth.META.GRCh37.txt.gz|META"
    "Verma_Science_2024.RandomGlucose.META.GRCh37.txt.gz|META"
)
...
echo ""
echo "=== Batch 2 (EUR + META) harmonization complete ==="
