...
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_fg_%J.out
#BSUB -e logs/lsf/harmonize_fg_%J.err

# Harmonize FastingGlucose GWAS files (3 total):
#   Chen_NatGenet_2021 — AMR, SAS
#   Chebii_Diabetologia_2025 — AFR
...
FILES=(
    "Chen_NatGenet_2021.FastingGlucose.AMR.GRCh37.txt.gz|AMR"
    "Chen_NatGenet_2021.FastingGlucose.SAS.GRCh37.txt.gz|SAS"
    "Chebii_Diabetologia_2025.FastingGlucose.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== FastingGlucose harmonization complete ==="
