#!/bin/bash
#BSUB -J harmonize_dbp
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_dbp_%J.out
#BSUB -e logs/lsf/harmonize_dbp_%J.err

# Harmonize DBP GWAS files (10 total):
#   Karczewski_NatGenet_2025 — EUR, SAS
#   Pozarickij_NatureComms_2024 — EAS
#   Verma_Science_2024 — META, EUR, AFR, AMR, EAS
#   Chen_CellGenomics_2023 — EAS
#   Singh_NatureComms_2023 — AFR
...
FILES=(
    "Karczewski_NatGenet_2025.DBP.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.DBP.SAS.GRCh37.txt.gz|SAS"
    "Pozarickij_NatureComms_2024.DBP.EAS.GRCh37.txt.gz|EAS"
    "Verma_Science_2024.DBP.META.GRCh37.tsv.gz|META"
    "Verma_Science_2024.DBP.EUR.GRCh37.tsv.gz|EUR"
    "Verma_Science_2024.DBP.AFR.GRCh37.tsv.gz|AFR"
    "Verma_Science_2024.DBP.AMR.GRCh37.tsv.gz|AMR"
    "Verma_Science_2024.DBP.EAS.GRCh37.tsv.gz|EAS"
    "Chen_CellGenomics_2023.DBP.EAS.GRCh37.tsv.gz|EAS"
    "Singh_NatureComms_2023.DBP.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== DBP harmonization complete ==="
