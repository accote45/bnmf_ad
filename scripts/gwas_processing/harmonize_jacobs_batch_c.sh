#!/bin/bash
#BSUB -J harmonize_jacobs_c
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_jacobs_c_%J.out
#BSUB -e logs/lsf/harmonize_jacobs_c_%J.err

# Harmonize Jacobs NatureComms 2024 SAS GWAS (batch C — 7 files):
#   NeutrophilCount, Phosphate, PltCount, Protein, RBC, RBCDistWidth, Urea
...
FILES=(
    "Jacobs_NatureComms_2024.NeutrophilCount.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.Phosphate.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.PltCount.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.Protein.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.RBC.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.RBCDistWidth.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.Urea.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== Jacobs batch C harmonization complete ==="
