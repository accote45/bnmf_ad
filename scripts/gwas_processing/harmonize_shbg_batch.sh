#!/bin/bash
#BSUB -J harmonize_shbg
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_shbg_%J.out
#BSUB -e logs/lsf/harmonize_shbg_%J.err

# Harmonize SHBG GWAS files (3 total):
...
FILES=(
    "Karczewski_NatGenet_2025.SHBG.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.SHBG.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.SHBG.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== SHBG batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*SHBG*.processed.txt.gz 2>/dev/null | wc -l)"
