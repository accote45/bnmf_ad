#!/bin/bash
#BSUB -J harmonize_alt
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_alt_%J.out
#BSUB -e logs/lsf/harmonize_alt_%J.err

# Harmonize ALT GWAS files (7 total):
...
FILES=(
    "Verma_Science_2024.ALT.META.GRCh37.txt.gz|META"
    "Verma_Science_2024.ALT.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.ALT.AFR.GRCh37.txt.gz|AFR"
    "Verma_Science_2024.ALT.AMR.GRCh37.txt.gz|AMR"
    "Verma_Science_2024.ALT.EAS.GRCh37.txt.gz|EAS"
    "Chen_CellGenomics_2023.ALT.EAS.GRCh37.tsv.gz|EAS"
    "Gurdasani_Cell_2019.ALT.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== ALT harmonization complete ==="
