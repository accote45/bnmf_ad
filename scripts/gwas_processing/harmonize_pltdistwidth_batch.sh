#!/bin/bash
#BSUB -J harmonize_pdw
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_pdw_%J.out
#BSUB -e logs/lsf/harmonize_pdw_%J.err

# Harmonize Platelet Distribution Width (PltDistWidth) GWAS files (3 total):
...
FILES=(
    "Karczewski_NatGenet_2025.PltDistWidth.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.PltDistWidth.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.PltDistWidth.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== PltDistWidth batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*PltDistWidth*.processed.txt.gz 2>/dev/null | wc -l)"
