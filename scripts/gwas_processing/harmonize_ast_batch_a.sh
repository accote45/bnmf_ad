#!/bin/bash
#BSUB -J harmonize_ast_a
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_ast_a_%J.out
#BSUB -e logs/lsf/harmonize_ast_a_%J.err

# Harmonize AST GWAS files (batch A — 3 UKB files):
...
FILES=(
    "UKB_Nature_2025.AST.EUR.GRCh37.tsv.gz|EUR"
    "UKB_Nature_2025.AST.AFR.GRCh37.tsv.gz|AFR"
    "UKB_Nature_2025.AST.SAS.GRCh37.tsv.gz|SAS"
)
...
echo ""
echo "=== AST batch A harmonization complete ==="
