#!/bin/bash
#BSUB -J harmonize_neut_rerun
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_neut_rerun_%J.out
#BSUB -e logs/lsf/harmonize_neut_rerun_%J.err

# Rerun: missing Neutrophil Count files (10 files)
...
echo ""
echo "=== NeutrophilCount rerun complete ==="
