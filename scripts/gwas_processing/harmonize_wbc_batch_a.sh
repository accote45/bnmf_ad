#!/bin/bash
#BSUB -J harmonize_wbc_a
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_wbc_a_%J.out
#BSUB -e logs/lsf/harmonize_wbc_a_%J.err

# Harmonize WBC GWAS files (batch A — 9 files):
...
FILES=(
    "Karczewski_NatGenet_2025.WBC.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.WBC.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.WBC.SAS.GRCh37.txt.gz|SAS"
    "Verma_Science_2024.WBC.META.GRCh37.txt.gz|META"
    "Verma_Science_2024.WBC.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.WBC.AFR.GRCh37.txt.gz|AFR"
    "Verma_Science_2024.WBC.EAS.GRCh37.txt.gz|EAS"
    "Verma_Science_2024.WBC.AMR.GRCh37.txt.gz|AMR"
    "Chen_CellGenomics_2023.WBC.EAS.GRCh37.tsv.gz|EAS"
)
...
echo ""
echo "=== WBC batch A harmonization complete ==="
