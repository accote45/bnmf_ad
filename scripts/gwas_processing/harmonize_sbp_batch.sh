#!/bin/bash
#BSUB -J harmonize_sbp
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_sbp_%J.out
#BSUB -e logs/lsf/harmonize_sbp_%J.err

# Harmonize SBP GWAS files (11 total):
...
FILES=(
    "Karczewski_NatGenet_2025.SBP.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.SBP.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.SBP.SAS.GRCh37.txt.gz|SAS"
    "Pozarickij_NatureComms_2024.SBP.EAS.GRCh37.txt.gz|EAS"
    "Verma_Science_2024.SBP.META.GRCh37.tsv.gz|META"
    "Verma_Science_2024.SBP.EUR.GRCh37.tsv.gz|EUR"
    "Verma_Science_2024.SBP.AFR.GRCh37.tsv.gz|AFR"
    "Verma_Science_2024.SBP.EAS.GRCh37.tsv.gz|EAS"
    "Verma_Science_2024.SBP.AMR.GRCh37.tsv.gz|AMR"
    "Chen_CellGenomics_2023.SBP.EAS.GRCh37.tsv.gz|EAS"
    "Gurdasani_Cell_2019.SBP.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== SBP harmonization complete ==="
