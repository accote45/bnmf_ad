#!/bin/bash
#BSUB -J harmonize_waistcircum
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_waistcircum_%J.out
#BSUB -e logs/lsf/harmonize_waistcircum_%J.err

# Harmonize Waist Circumference GWAS files (7 total):
#   Karczewski_NatGenet_2025 — META, EUR, AFR, SAS
#   Jo_GenomicsProteomics_2025 — EAS
...
FILES=(
    "Karczewski_NatGenet_2025.WaistCircum.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.WaistCircum.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.WaistCircum.AFR.GRCh37.txt.gz|AFR"
    "Karczewski_NatGenet_2025.WaistCircum.SAS.GRCh37.txt.gz|SAS"
    "Jo_GenomicsProteomics_2025.WaistCircum.EAS.GRCh37.txt.gz|EAS"
    "Chen_CellGenomics_2023.WaistCircum.EAS.GRCh37.tsv.gz|EAS"
    "Gurdasani_Cell_2019.WaistCircum.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== Waist Circumference harmonization complete ==="
