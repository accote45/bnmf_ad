#!/bin/bash
#BSUB -J harmonize_bmi_a
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=128000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_bmi_a_%J.out
#BSUB -e logs/lsf/harmonize_bmi_a_%J.err

# Harmonize BMI GWAS files (batch A — 7 files, 128GB mem):
...
FILES=(
    "Jo_GenomicsProteomics_2025.BMI.EAS.GRCh37.txt.gz|EAS"
    "Karczewski_NatGenet_2025.BMI.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.BMI.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.BMI.AFR.GRCh37.txt.gz|AFR"
    "Karczewski_NatGenet_2025.BMI.SAS.GRCh37.txt.gz|SAS"
    "Chen_CellGenomics_2023.BMI.EAS.GRCh37.tsv.gz|EAS"
    "FernandezRhodes_HGGAdv_2022.BMI.AMR.GRCh37.txt.gz|AMR"
)
...
echo ""
echo "=== BMI batch A harmonization complete ==="
