#!/bin/bash
#BSUB -J harmonize_rbc
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_rbc_%J.out
#BSUB -e logs/lsf/harmonize_rbc_%J.err

# Harmonize all RBC (Red Blood Cell Count) GWAS files (11 total):
...
FILES=(
    ...
    "Karczewski_NatGenet_2025.RBC.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.RBC.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.RBC.SAS.GRCh37.txt.gz|SAS"
    # Verma Science 2024
    "Verma_Science_2024.RBC.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.RBC.AFR.GRCh37.txt.gz|AFR"
    "Verma_Science_2024.RBC.EAS.GRCh37.txt.gz|EAS"
    "Verma_Science_2024.RBC.AMR.GRCh37.txt.gz|AMR"
    "Verma_Science_2024.RBC.META.GRCh37.txt.gz|META"
    # Sakaue NatGenet 2021
    "Sakaue_NatGenet_2021.RBC.EAS.GRCh37.txt.gz|EAS"
    # Chen CellGenomics 2023
    "Chen_CellGenomics_2023.RBC.EAS.GRCh37.tsv.gz|EAS"
    # Gurdasani Cell 2019 (custom METAL format)
    "Gurdasani_Cell_2019.RBC.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== RBC batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*RBC*.processed.txt.gz 2>/dev/null | wc -l)"
