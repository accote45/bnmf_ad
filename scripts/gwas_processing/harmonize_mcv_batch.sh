#!/bin/bash
#BSUB -J harmonize_mcv
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_mcv_%J.out
#BSUB -e logs/lsf/harmonize_mcv_%J.err

# Harmonize all MCV (Mean Corpuscular Volume) GWAS files (15 total):
...
FILES=(
    # Chen Cell 2020
    "Chen_Cell_2020.MCV.EUR.GRCh37.txt.gz|EUR"
    "Chen_Cell_2020.MCV.AFR.GRCh37.txt.gz|AFR"
    "Chen_Cell_2020.MCV.EAS.GRCh37.txt.gz|EAS"
    "Chen_Cell_2020.MCV.SAS.GRCh37.txt.gz|SAS"
    "Chen_Cell_2020.MCV.AMR.GRCh37.txt.gz|AMR"
    # Karczewski NatGenet 2025
    "Karczewski_NatGenet_2025.MCV.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.MCV.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.MCV.SAS.GRCh37.txt.gz|SAS"
    # Sakaue NatGenet 2021
    "Sakaue_NatGenet_2021.MCV.EAS.GRCh37.txt.gz|EAS"
    # Verma Science 2024
    "Verma_Science_2024.MCV.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.MCV.AFR.GRCh37.txt.gz|AFR"
    "Verma_Science_2024.MCV.EAS.GRCh37.txt.gz|EAS"
    "Verma_Science_2024.MCV.AMR.GRCh37.txt.gz|AMR"
    "Verma_Science_2024.MCV.META.GRCh37.txt.gz|META"
    # Gurdasani Cell 2019 (custom METAL format)
    "Gurdasani_Cell_2019.MCV.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== MCV batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*MCV*.processed.txt.gz 2>/dev/null | wc -l)"
