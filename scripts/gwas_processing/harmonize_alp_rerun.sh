#!/bin/bash
#BSUB -J harmonize_alp_re
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=128000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_alp_re_%J.out
#BSUB -e logs/lsf/harmonize_alp_re_%J.err

# Rerun ALP harmonization — Gurdasani AFR (OOM at 64GB)
...
echo ""
echo "=== ALP rerun harmonization complete ==="
