#!/bin/bash
#BSUB -J harmonize_urea
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_urea_%J.out
#BSUB -e logs/lsf/harmonize_urea_%J.err

# Harmonize Urea GWAS files (3 total):
...
FILES=(
    "Karczewski_NatGenet_2025.Urea.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.Urea.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.Urea.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== Urea batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*Urea*.processed.txt.gz 2>/dev/null | wc -l)"
