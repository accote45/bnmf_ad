#!/bin/bash
#BSUB -J harmonize_ast
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_ast_%J.out
#BSUB -e logs/lsf/harmonize_ast_%J.err

# Harmonize AST GWAS files (5 total):
...
echo ""
echo "=== AST harmonization complete ==="
