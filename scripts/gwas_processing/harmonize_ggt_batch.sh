#!/bin/bash
#BSUB -J harmonize_ggt
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_ggt_%J.out
#BSUB -e logs/lsf/harmonize_ggt_%J.err

# Harmonize GGT GWAS files (3 total):
...
FILES=(
    "Karczewski_NatGenet_2025.GGT.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.GGT.SAS.GRCh37.txt.gz|SAS"
    "Chen_CellGenomics_2023.GGT.EAS.GRCh37.tsv.gz|EAS"
)
...
echo ""
echo "=== GGT harmonization complete ==="
