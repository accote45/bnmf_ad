#!/bin/bash
#BSUB -J harm_ukb_rg_eur
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=128000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harm_ukb_rg_eur_%J.out
#BSUB -e logs/lsf/harm_ukb_rg_eur_%J.err

# UKB RandomGlucose EUR (84M variants, GRCh38 liftover — needs high memory)
...
echo ""
echo "=== UKB RandomGlucose EUR harmonization complete ==="
