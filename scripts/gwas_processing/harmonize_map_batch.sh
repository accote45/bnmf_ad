#!/bin/bash
#BSUB -J harmonize_map
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_map_%J.out
#BSUB -e logs/lsf/harmonize_map_%J.err

# Harmonize MAP (Mean Arterial Pressure) GWAS files:
#   1. Karczewski_NatGenet_2025.MAP.EUR.GRCh37
#   2. Karczewski_NatGenet_2025.MAP.META.GRCh37
#   3. Karczewski_NatGenet_2025.MAP.SAS.GRCh37
#   4. Sakaue_NatGenet_2021.MAP.EAS.GRCh37
...
FILES=(
    "Karczewski_NatGenet_2025.MAP.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.MAP.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.MAP.SAS.GRCh37.txt.gz|SAS"
    "Sakaue_NatGenet_2021.MAP.EAS.GRCh37.txt.gz|EAS"
)
...
echo ""
echo "=== MAP batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*MAP*.processed.txt.gz 2>/dev/null | wc -l)"
