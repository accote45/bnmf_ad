#!/bin/bash
#BSUB -J harmonize_retic
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_retic_%J.out
#BSUB -e logs/lsf/harmonize_retic_%J.err

# Harmonize Reticulocyte Count GWAS files (3 total):
...
FILES=(
    "Karczewski_NatGenet_2025.ReticulocyteCount.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.ReticulocyteCount.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.ReticulocyteCount.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== ReticulocyteCount batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*ReticulocyteCount*.processed.txt.gz 2>/dev/null | wc -l)"
