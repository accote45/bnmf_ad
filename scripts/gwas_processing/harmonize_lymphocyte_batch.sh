#!/bin/bash
#BSUB -J harmonize_lymph
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_lymph_%J.out
#BSUB -e logs/lsf/harmonize_lymph_%J.err

# Harmonize all Lymphocyte Count GWAS files (14 total):
#   Chen_Cell_2020        — EUR, AFR, EAS, SAS, AMR
#   Karczewski_NatGenet_2025 — EUR, META, SAS
...
FILES=(
    # Chen Cell 2020 (GWAS Catalog harmonized format)
    "Chen_Cell_2020.LymphocyteCount.EUR.GRCh37.txt.gz|EUR"
    "Chen_Cell_2020.LymphocyteCount.AFR.GRCh37.txt.gz|AFR"
    "Chen_Cell_2020.LymphocyteCount.EAS.GRCh37.txt.gz|EAS"
    "Chen_Cell_2020.LymphocyteCount.SAS.GRCh37.txt.gz|SAS"
    "Chen_Cell_2020.LymphocyteCount.AMR.GRCh37.txt.gz|AMR"
    # Karczewski NatGenet 2025 (GWAS Catalog harmonized format)
    "Karczewski_NatGenet_2025.LymphocyteCount.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.LymphocyteCount.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.LymphocyteCount.SAS.GRCh37.txt.gz|SAS"
    # Sakaue NatGenet 2021 (GWAS Catalog harmonized format)
    "Sakaue_NatGenet_2021.LymphocyteCount.EAS.GRCh37.txt.gz|EAS"
    # Verma Science 2024 (GWAS Catalog harmonized format)
    "Verma_Science_2024.LymphocyteCount.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.LymphocyteCount.AFR.GRCh37.txt.gz|AFR"
    "Verma_Science_2024.LymphocyteCount.AMR.GRCh37.txt.gz|AMR"
    "Verma_Science_2024.LymphocyteCount.META.GRCh37.txt.gz|META"
    # Gurdasani Cell 2019 (custom METAL format)
    "Gurdasani_Cell_2019.LymphocyteCount.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== Lymphocyte Count batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*LymphocyteCount*.processed.txt.gz 2>/dev/null | wc -l)"
