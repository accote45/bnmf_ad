#!/bin/bash
#BSUB -J harmonize_testo
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 12:00
#BSUB -o logs/lsf/harmonize_testo_%J.out
#BSUB -e logs/lsf/harmonize_testo_%J.err

# Harmonize Testosterone GWAS files (4 total):
#   Venkatesh_NatureGenetics_2025 — META
#   UKB_Nature_2025              — EUR, AFR, SAS
...
FILES=(
    # Venkatesh NatureGenetics 2025
    "Venkatesh_NatureGenetics_2025.Testosterone.META.GRCh37.tsv.gz|META"
    # UKB Nature 2025
    "UKB_Nature_2025.Testosterone.EUR.GRCh37.tsv.gz|EUR"
    "UKB_Nature_2025.Testosterone.AFR.GRCh37.tsv.gz|AFR"
    "UKB_Nature_2025.Testosterone.SAS.GRCh37.tsv.gz|SAS"
)
...
echo ""
echo "=== Testosterone batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*Testosterone*.processed.txt.gz 2>/dev/null | wc -l)"
