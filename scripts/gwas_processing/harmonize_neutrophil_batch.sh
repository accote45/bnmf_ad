#!/bin/bash
#BSUB -J harmonize_neut
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 8:00
#BSUB -o logs/lsf/harmonize_neut_%J.out
#BSUB -e logs/lsf/harmonize_neut_%J.err

# Harmonize all Neutrophil Count GWAS files (14 total):
...
FILES=(
    # Chen Cell 2020
    "Chen_Cell_2020.NeutrophilCount.EUR.GRCh37.txt.gz|EUR"
    "Chen_Cell_2020.NeutrophilCount.AFR.GRCh37.txt.gz|AFR"
    "Chen_Cell_2020.NeutrophilCount.EAS.GRCh37.txt.gz|EAS"
    "Chen_Cell_2020.NeutrophilCount.SAS.GRCh37.txt.gz|SAS"
    "Chen_Cell_2020.NeutrophilCount.AMR.GRCh37.txt.gz|AMR"
    # Karczewski NatGenet 2025
    "Karczewski_NatGenet_2025.NeutrophilCount.EUR.GRCh37.txt.gz|EUR"
    "Karczewski_NatGenet_2025.NeutrophilCount.META.GRCh37.txt.gz|META"
    "Karczewski_NatGenet_2025.NeutrophilCount.SAS.GRCh37.txt.gz|SAS"
    # Sakaue NatGenet 2021
    "Sakaue_NatGenet_2021.NeutrophilCount.EAS.GRCh37.txt.gz|EAS"
    # Verma Science 2024
    "Verma_Science_2024.NeutrophilCount.EUR.GRCh37.txt.gz|EUR"
    "Verma_Science_2024.NeutrophilCount.AFR.GRCh37.txt.gz|AFR"
    "Verma_Science_2024.NeutrophilCount.AMR.GRCh37.txt.gz|AMR"
    "Verma_Science_2024.NeutrophilCount.META.GRCh37.txt.gz|META"
    # Gurdasani Cell 2019 (custom METAL format)
    "Gurdasani_Cell_2019.NeutrophilCount.AFR.GRCh37.txt.gz|AFR"
)
...
echo ""
echo "=== NeutrophilCount batch harmonization complete ==="
echo "  Total: ${TOTAL}, Processed: ${COUNT}, Failed: ${FAILED}"
echo "  Harmonized files: $(ls ${HARMONIZED}/*NeutrophilCount*.processed.txt.gz 2>/dev/null | wc -l)"
