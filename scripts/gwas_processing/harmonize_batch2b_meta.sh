#!/bin/bash
#BSUB -J harm_batch2b_meta
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 12:00
#BSUB -o logs/lsf/harm_batch2b_meta_%J.out
#BSUB -e logs/lsf/harm_batch2b_meta_%J.err

# Batch 2b: META files (4 files)
...
echo ""
echo "=== Batch 2b (META) harmonization complete ==="
