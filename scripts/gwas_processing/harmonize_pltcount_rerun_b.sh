#!/bin/bash
#BSUB -J harmonize_plt_rerun_b
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_plt_rerun_b_%J.out
#BSUB -e logs/lsf/harmonize_plt_rerun_b_%J.err

# Rerun: missing Platelet Count files (batch B — 4 files)
...
echo ""
echo "=== PltCount rerun B complete ==="
