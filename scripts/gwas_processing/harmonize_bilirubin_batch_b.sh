#!/bin/bash
#BSUB -J harmonize_bili_b
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_bili_b_%J.out
#BSUB -e logs/lsf/harmonize_bili_b_%J.err

# Harmonize Bilirubin GWAS files (batch B — 1 file):
...
echo ""
echo "=== Bilirubin batch B harmonization complete ==="
