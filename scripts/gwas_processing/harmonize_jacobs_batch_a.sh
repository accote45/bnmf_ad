#!/bin/bash
#BSUB -J harmonize_jacobs_a
#BSUB -P acc_paul_oreilly
#BSUB -q premium
#BSUB -n 32
#BSUB -R "rusage[mem=64000]"
#BSUB -W 16:00
#BSUB -o logs/lsf/harmonize_jacobs_a_%J.out
#BSUB -e logs/lsf/harmonize_jacobs_a_%J.err

# Harmonize Jacobs NatureComms 2024 SAS GWAS (batch A — 7 files):
#   ALP, ALT, AST, Bilirubin, Calcium, Creatinine, CRP
...
FILES=(
    "Jacobs_NatureComms_2024.ALP.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.ALT.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.AST.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.Bilirubin.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.Calcium.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.Creatinine.SAS.GRCh37.txt.gz|SAS"
    "Jacobs_NatureComms_2024.CRP.SAS.GRCh37.txt.gz|SAS"
)
...
echo ""
echo "=== Jacobs batch A harmonization complete ==="
